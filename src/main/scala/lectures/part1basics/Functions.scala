...
object Functions extends App {
  ...
  /*
   1. A greeting function (name, age) => "Hi, my name is $name and I and $age years old."
  ...
  println(greetingForKids("Bora", 54))
  ...
  def fabbionaci(n: Int): Int =
    if (n <= 2) 1
    else fabbionaci(n - 1) + fabbionaci(n - 2)

  println(fabbionaci(8))
